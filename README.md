...
- **7 supported tools, private gateway friendly** — Claude Code, Claude Desktop, Codex, Gemini CLI, OpenCode, OpenClaw, Hermes; start from official providers or add your own gateway
