...
**[Use puppyrouter app to configure, manage, and switch Claude Desktop providers in one place](../user-manual/en/2-providers/2.6-claude-desktop.md)**
...
puppyrouter app now treats **Claude Desktop** as a first-class managed surface alongside Claude Code / Codex / Gemini / OpenCode / OpenClaw / Hermes.

- New dedicated Claude Desktop panel that brokers third-party providers to Claude Desktop through puppyrouter app's in-app proxy gateway
...
ChatGPT Codex providers no longer rely on a hardcoded model selection — puppyrouter app fetches a **live model list** from the ChatGPT backend on demand.
...
Switching a Claude Desktop provider writes puppyrouter app's managed 3P profile and **requires restarting Claude Desktop** to take effect; proxy-mode providers require puppyrouter app's Local Routing to stay running while in use.
...
### puppyrouter app Brand Surface Unified to puppyrouter.com

All in-app and README "official website" references now point at puppyrouter.com as the sole official site; the release notes template also surfaces puppyrouter.com.
...
The release notes template now surfaces `puppyrouter.com`.

### Brand Surface

Documented `puppyrouter.com` as the sole official website across READMEs and in-app references.
...
| File                                     | Description                                           |
| ---------------------------------------- | ----------------------------------------------------- |
| `puppyrouter-app-v3.15.0-Windows.msi`          | **Recommended** - MSI installer, supports auto-update |
| `puppyrouter-app-v3.15.0-Windows-Portable.zip` | Portable, extract and run, no registry writes         |

### macOS

| File                             | Description                                             |
| -------------------------------- | ------------------------------------------------------- |
| `puppyrouter-app-v3.15.0-macOS.dmg`    | **Recommended** - DMG installer, drag into Applications |
| `puppyrouter-app-v3.15.0-macOS.zip`    | Extract and drag into Applications, Universal Binary    |
| `puppyrouter-app-v3.15.0-macOS.tar.gz` | For Homebrew installation and auto-update               |
...
>
> - `puppyrouter-app-v3.15.0-Linux-x86_64.AppImage` / `.deb` / `.rpm`
> - `puppyrouter-app-v3.15.0-Linux-arm64.AppImage` / `.deb` / `.rpm`
