...
puppyrouter app v3.7.0 introduces six major features with over 18,000 lines of new code.
...
- **Windows**: `puppyrouter-app-v3.7.0-Windows.msi` or `-Portable.zip`
- **macOS**: `puppyrouter-app-v3.7.0-macOS.tar.gz` or `.zip`
- **Linux**: `puppyrouter-app-v3.7.0-Linux.AppImage` or `.deb`
