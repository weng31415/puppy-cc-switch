# puppyrouter app v3.6.1

> Stability improvements and user experience optimization (based on v3.6.0)

**[中文更新说明 Chinese Documentation →](https://github.com/farion1231/puppyrouter-app/blob/main/docs/release-notes/v3.6.1-zh.md)**
...
- Download `puppyrouter-app-v3.6.1-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `puppyrouter-app-v3.6.1-Windows.msi`
- **Portable**: `puppyrouter-app-v3.6.1-Windows-Portable.zip`

#### Linux

- **AppImage**: `puppyrouter-app-v3.6.1-Linux.AppImage`
- **Debian**: `puppyrouter-app-v3.6.1-Linux.deb`

---

### 📚 Documentation

- [中文文档 (Chinese)](https://github.com/farion1231/puppyrouter-app/blob/main/README_ZH.md)
- [English Documentation](https://github.com/farion1231/puppyrouter-app/blob/main/README.md)
- [完整更新日志 (Full Changelog)](https://github.com/farion1231/puppyrouter-app/blob/main/CHANGELOG.md)
...
**Full Changelog**: https://github.com/farion1231/puppyrouter-app/compare/v3.6.0...v3.6.1
...
- **Customizable Storage Location** - Customize puppyrouter app's configuration storage directory
...
## 🌟 About puppyrouter app

puppyrouter app is a cross-platform desktop application for managing and switching between different provider configurations for Claude Code and Codex. Built with Tauri 2.0 + React 18 + TypeScript, supporting Windows, macOS, and Linux.
...
**Project Repository**: https://github.com/farion1231/puppyrouter-app
