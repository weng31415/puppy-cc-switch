...
- **ArchLinux Installation Support** (#259)
  Added AUR installation method: `paru -S puppyrouter-app-bin`
...
Visit [Releases](https://github.com/farion1231/puppyrouter-app/releases/latest) to download the latest version
...
- **Deep link integration** - Import via `puppyrouter://` protocol
...
### Deep Link Protocol (puppyrouter://)
...
v3.7.0 represents a shift in puppyrouter app's positioning:
...
Visit [Releases](https://github.com/farion1231/puppyrouter-app/releases/latest) to download:

- **Windows**: `puppyrouter-app-Windows.msi` or `-Portable.zip`
- **macOS**: `puppyrouter-app-macOS.tar.gz` or `.zip`
- **Linux**: `puppyrouter-app-Linux.AppImage` or `.deb`
- **ArchLinux**: `paru -S puppyrouter-app-bin`
...
[Register with "puppyrouter-app" code for 10% discount](https://www.packyapi.com/register?aff=puppyrouter-app)
...
- **Issues**: [GitHub Issues](https://github.com/farion1231/puppyrouter-app/issues)
- **Discussions**: [GitHub Discussions](https://github.com/farion1231/puppyrouter-app/discussions)
