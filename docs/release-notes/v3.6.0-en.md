...
**[中文更新说明 Chinese Documentation →](https://github.com/farion1231/puppyrouter-app/blob/main/docs/release-notes/v3.6.0-zh.md)**
...
- Download `puppyrouter-app-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `puppyrouter-app-v3.6.0-Windows.msi`
- **Portable**: `puppyrouter-app-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**: `puppyrouter-app-v3.6.0-Linux.AppImage`
- **Debian**: `puppyrouter-app-v3.6.0-Linux.deb`
...
**Full Changelog**: https://github.com/farion1231/puppyrouter-app/compare/v3.5.1...v3.6.0
