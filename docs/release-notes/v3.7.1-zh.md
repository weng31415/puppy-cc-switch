...
- **ArchLinux 安装支持** (#259)
  添加 AUR 安装方式：`paru -S puppyrouter-app-bin`
...
访问 [Releases](https://github.com/farion1231/puppyrouter-app/releases/latest) 下载最新版本
...
v3.7.0 代表了 puppyrouter app 定位的转变：
...
访问 [Releases](https://github.com/farion1231/puppyrouter-app/releases/latest) 下载：

- **Windows**：`puppyrouter-app-Windows.msi` 或 `-Portable.zip`
- **macOS**：`puppyrouter-app-macOS.tar.gz` 或 `.zip`
- **Linux**：`puppyrouter-app-Linux.AppImage` 或 `.deb`
...
[使用 "puppyrouter-app" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=puppyrouter-app)
...
- **问题反馈**：[GitHub Issues](https://github.com/farion1231/puppyrouter-app/issues)
- **讨论**：[GitHub Discussions](https://github.com/farion1231/puppyrouter-app/discussions)
