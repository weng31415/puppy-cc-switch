...
puppyrouter app provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
puppyrouter://import/prompt?data=<base64-encoded preset>
```
