...
**On macOS:**
- puppyrouter app launches your preferred terminal with the resume command
...
3. puppyrouter app launches the Claude terminal session in the selected directory
