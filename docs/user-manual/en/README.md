...
| File | Description |
|------|-------------|
| [5.1-config-files.md](./5-faq/5.1-config-files.md) | puppyrouter app storage, CLI configuration file formats |
...
- Applicable to puppyrouter app v3.16.0+
