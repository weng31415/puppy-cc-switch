...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (puppyrouter app)
...
After starting the proxy and enabling app takeover, puppyrouter app modifies app configurations:
...
When stopping the proxy, puppyrouter app will:
