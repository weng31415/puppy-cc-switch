...
puppyrouter app provides rich icon customization features:
...
This ensures puppyrouter app and CLI tool configurations stay in sync.
...
When adding a provider, puppyrouter app automatically extracts endpoint URLs from the configuration.
