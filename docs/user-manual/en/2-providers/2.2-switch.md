...
2. puppyrouter app updates the configuration file
...
1. Right-click the puppyrouter app icon in the system tray
...
When switching providers, puppyrouter app modifies the following files:
