  ...
  const autoSaveSettings = useCallback(
    async (updates: Partial<SettingsFormState>): Promise<SaveResult | null> => {
      ...
      try {
        ...
        const sanitizedGrokbuildDir = sanitizeDir(mergedSettings.grokConfigDir);
        ...
        const payload: Settings = {
          ...
          grokConfigDir: sanitizedGrokbuildDir,
  ...
  const saveSettings = useCallback(
    async (
      ...
      try {
        ...
        const previousGrokbuildDir = sanitizeDir(data?.grokConfigDir);
        ...
        const grokbuildDirChanged =
          sanitizedGrokbuildDir !== previousGrokbuildDir;
