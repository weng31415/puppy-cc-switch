//! Deep link import functionality for puppyrouter app
//!
//! This module implements the puppyrouter:// protocol for importing configurations
...
///
/// Represents a parsed puppyrouter:// URL ready for processing.
