...
impl McpApps {
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::GrokBuild => {} // Grok Build MCP is intentionally unsupported
...
impl SkillApps {
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::Codex => self.codex = enabled,
            AppType::Gemini => self.gemini = enabled,
            AppType::GrokBuild => {} // Grok Build Skills are intentionally unsupported
            AppType::OpenCode => self.opencode = enabled,
            AppType::Hermes => self.hermes = enabled,
...
pub struct McpRoot {
    ...
    /// Reserved for config compatibility. Grok Build MCP is not exposed or synced.
    #[serde(default, skip_serializing_if = "McpConfig::is_empty")]
...
impl MultiAppConfig {
    ...
    pub fn load() -> Result<Self, AppError> {
        ...
        // Ensure apps introduced after the original multi-app config exist.
        for app_id in ["gemini", "grokbuild"] {
    ...
    fn auto_import_prompt_if_exists(config: &mut Self, app: AppType) -> Result<bool, AppError> {
        ...
        let prompts = match app {
            ...
            AppType::GrokBuild => return Ok(false),
    ...
    pub fn migrate_mcp_to_unified(&mut self) -> Result<bool, AppError> {
        ...
        for app in [
            ...
            let old_servers = match app {
                ...
                AppType::GrokBuild => continue, // Grok Build MCP is intentionally unsupported
