...
//!
//! Handles conversion between puppyrouter app unified MCP format and Hermes config.yaml format.
//!
//! ## Format mapping
//!
//! | puppyrouter app unified (JSON)                        | Hermes config.yaml (YAML)       |
//! |-------------------------------------------------|---------------------------------|
...
/// puppyrouter app has no OAuth UI, but losing the field on round-trip downgrades
...
// ============================================================================
// Format Conversion: puppyrouter app -> Hermes
// ============================================================================

/// Convert puppyrouter app unified format to Hermes format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: Hermes -> puppyrouter app
// ============================================================================

/// Convert Hermes format to puppyrouter app unified format
///
/// Conversion rules:
...
/// `existing` — this prevents puppyrouter app from overwriting user customizations.
...
mod tests {
    ...
    fn test_merge_preserves_auth_field() {
        ...
        assert_eq!(
            merged["auth"], "oauth",
            "auth declaration must survive puppyrouter app round-trip"
        );
    }
