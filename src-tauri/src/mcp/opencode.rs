...
//!
//! 本模块处理 puppyrouter app 统一 MCP 格式与 OpenCode 格式之间的转换。
//!
//! ## 格式差异
//!
//! | puppyrouter app 统一格式    | OpenCode 格式       |
//! |----------------------|---------------------|
...
// ============================================================================
// Format Conversion: puppyrouter app → OpenCode
// ============================================================================

/// Convert puppyrouter app unified format to OpenCode format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: OpenCode → puppyrouter app
// ============================================================================

/// Convert OpenCode format to puppyrouter app unified format
///
/// Conversion rules:
